...
class SlidersApp:
    ...
    def update_face_shape(self, idx: int):
        def update_face_shape_values(value: float):
            ...
            verts, _, _, _ = self.utils.get_flame_model(shape_params=self.face_shape)
    ...
    def update_beta_shape(self, idx: int):
        def update_beta_shape_values(value: float):
            ...
            verts, _, _, _ = self.utils.get_smal_model(beta=self.beta)
...
@hydra.main(config_path="config", config_name="sliders_demo")
def main(cfg):
